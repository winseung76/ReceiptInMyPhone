...
import com.bukcoja.seung.receipt_inmyhand.View.LunchFragment.OnListFragmentInteractionListener;
 ...
 */
public class LunchRecyclerViewAdapter extends RecyclerView.Adapter<LunchRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;
    private final Context context;

    public LunchRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener, Context context) {
        mValues = items;
        mListener = listener;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_lunch, parent, false);
