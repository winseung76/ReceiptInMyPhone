...
import com.bukcoja.seung.receipt_inmyhand.View.DinnerFragment.OnListFragmentInteractionListener;
 ...
 */
public class DinnerRecyclerViewAdapter extends RecyclerView.Adapter<DinnerRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;
    private final Context context;

    public DinnerRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener,Context context) {
        mValues = items;
        mListener = listener;
